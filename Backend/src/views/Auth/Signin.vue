          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
              <div class="mb-5 sm:mb-8">
                ...
                <div class="bg-red-50 text-sm text-red-600 px-3 py-1 rounded-md mt-2" v-if="authError">{{ authError }}</div>
              </div>
              <div>
                  ...
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      <input v-model="email" type="email" id="email" name="email" placeholder="info@gmail.com"
                        ...
                        <p class="text-red-700 mt-1 text-sm" v-if="errors.email">{{ errors.email[0] }}</p>
                    </div>
                    <!-- Password -->
                    <div>
                      ...
                      <div class="relative">
                        <input v-model="password" :type="showPassword ? 'text' : 'password'" id="password"
                          ...
                          <p class="text-red-700 mt-1 text-sm" v-if="errors.password">{{ errors.password[0] }}</p>
