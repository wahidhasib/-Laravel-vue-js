<template>
    <div class="p-2 flex flex-col border-b-2 border-gray-50 hover:border-primary cursor-pointer group transition-all duration-500">
        ...
        <h4 class="text-lg text-gray-700 text-center mt-3 font-semibold duration-500">Free Shipping</h4>
        <p class="text-sm text-gray-600 text-center">Free shipping with discount</p>
    </div>
</template>